  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden bg-[var(--color-primary-700)]">
      ...
      <div className="relative mx-auto flex min-h-[88vh] max-w-6xl flex-col justify-end px-4 pb-16 pt-28 sm:px-6 sm:pb-20">
        <p className="animate-fade-up font-[family-name:var(--font-nunito-sans)] text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">
          {brand}
        </p>
        <h1 className="animate-fade-up-delay mt-5 max-w-2xl font-[family-name:var(--font-nunito-sans)] text-2xl font-bold leading-tight text-white sm:text-3xl md:text-4xl">
          {h1}
        </h1>
