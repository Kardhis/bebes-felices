...
final class MovementAmazonProducts {
    ...
    static List<Product> all() {
        return List.of(
                ...
                product("trepar-mamoi-triangulo-natural", "B08DJ8SZYG",
                        "MAMOI triángulo de escalada natural",
                        "Triángulo de pino con tobogán de dos caras, carga de 60 kg y edad declarada a partir de 36 meses.",
                        3, 6, "Estructuras de trepar"),
                ...
                product("trepar-little-tikes-tobogan", "B006YMOCOS",
                        "Little Tikes tobogán azul y verde",
                        "Tobogán bajo de 110 cm, escalones y pasamanos, de 18 meses a 5 años, interior o exterior.",
                        1, 5, "Estructuras de trepar"),
