...
final class EducationalAmazonProducts {
    ...
    static List<Product> all() {
        return List.of(
                ...
                product("puzle-melissa-granja", "B004KPKW40", "Melissa & Doug puzle de animales domésticos", "Tablero de madera con piezas grandes y sonidos para reconocer animales.", 2, 4, "Puzles"),
                ...
                product("simbolico-deao-cocina", "B0BQR6BFNW", "deAO cocina con 48 accesorios", "Cocina compacta con fregadero, utensilios y zonas de almacenamiento.", 3, 8, "Juego simbólico"),
                product("simbolico-beeloom-babycue", "B07YLHRQVY", "Beeloom Babycue", "Cocinita portátil de madera con utensilios para juego de imitación.", 3, 9, "Juego simbólico"),
                product("simbolico-sundaymot-32", "B098QCJRFF", "Sundaymot maletín médico de 32 piezas", "Maletín de médico y dentista con bata, estetoscopio y accesorios.", 3, 8, "Juego simbólico"),
                ...
                product("sensorial-playfoam", "B008CPB5UY", "Learning Resources Playfoam, 6 bloques", "Espuma moldeable que no se seca ni se pega, para explorar textura y forma.", 3, 8, "Sensoriales"),
